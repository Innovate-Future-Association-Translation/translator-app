...
import { Box, Button, Center, Flex, Heading, Input, Stack, Text, Link } from '@chakra-ui/react';
...
function SignUpContent() {
  ...
  }, [pageFromAuth, router, pathname, searchParams]);
  ...
  const handleGoogleOauth = () => {
    window.location.href = `${process.env.NEXT_PUBLIC_API_BASE_URL}/users/googleAuth`;
  };
