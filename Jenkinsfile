            ...
            steps {
                dir('out') {
                    sh '''
                        ...
                        aws s3 cp . s3://ifa-frontend-s3/ --recursive
                    '''
                }
            }
        }
